...
# stock vendor modules still load. This matters most for the toolbox targets,
# which expand the config. Run verify_stock_module_abi.py by hand before any
# device test; see warsaw/kleaf/README.md.
